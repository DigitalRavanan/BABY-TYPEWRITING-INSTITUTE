  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 p-8 font-sans">
      <header className="flex justify-between items-center max-w-7xl mx-auto mb-12">
        ...
        <button className="bg-red-600 hover:bg-red-700 text-white rounded-full px-5 py-2 shadow-lg transition">
          Logout
        </button>
      </header>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="bg-white bg-opacity-80 backdrop-blur-md rounded-3xl p-8 shadow-xl hover:shadow-2xl transition cursor-default">
          ...
          <button className="mt-6 w-full bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-full font-semibold shadow-lg transition-transform transform hover:scale-105">
            Manage Students
          </button>
        </div>
